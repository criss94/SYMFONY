      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="main-nav">
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="<?php echo url_for('@sf_guard_permission') ?>">Mis Aplicaciones</a></li>
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
        ...
        <div class="row">
            <div class="col-xs-12">
                <ol class="breadcrumb white">
                    <li><a href="<?php echo url_for('@sf_guard_permission') ?>">Inicio</a></li>
                    <li>Permisos</li>
                    <?php if($sf_params->get('id')): ?>
                    <li>Editar</li>
                    <li class="active"><?php echo $sf_guard_permission->getName() ?></li>
                    <?php else: ?>
