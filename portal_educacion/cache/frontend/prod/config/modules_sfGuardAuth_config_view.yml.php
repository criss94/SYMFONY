...
$response = $this->context->getResponse();
  ...
  $response->addStylesheet('slick.css', '', array ());
  $response->addStylesheet('slick-theme.css', '', array ());
  $response->addStylesheet('styles.css', '', array ());
  $response->addJavascript('jquery-2.min.js', '', array ());
  ...
  $response->addJavascript('slick.min.js', '', array ());
