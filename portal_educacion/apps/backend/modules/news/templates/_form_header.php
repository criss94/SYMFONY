      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="main-nav">
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="<?php echo url_for('@noticias') ?>">Mis Aplicaciones</a></li>
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
        ...
        <div class="row">
            <div class="col-xs-12">
                <ol class="breadcrumb white">
                    <li><a href="<?php echo url_for('@noticias') ?>">Inicio</a></li>
                    <li>Noticias</li>
                    <?php if($sf_params->get('id')): ?>
                    <li>Editar</li>
                    <li class="active"><?php echo $noticias->getNotNombre() ?></li>
                    <?php else: ?>
